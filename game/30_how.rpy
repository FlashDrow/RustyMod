...
label about_this_mod:
    ...
    show screen andem
    with dissolve
    angel "Мы хотим представить вам этот небольшой фан мод на замечательную игру \"Witch trainer\""

    hide screen andem
    $ andem = "f/and3.png"
    show screen andem
    with dissolve
    demoness "Этот мод сделан на основе оригинальной версии 1.02"

    hide screen andem
    $ andem = "f/and6.png"
    show screen andem
    with dissolve
    angel "Если вы каким-либо образом скачали мод, не поиграв в оригинал, советую вам сделать это. Вы можете скачать оригинал на страничке автора: {a=http://www.patreon.com/akabur}www.patreon.com/akabur{/a}"

    hide screen andem
    $ andem = "f/and3.png"
    show screen andem
    with dissolve
    demoness "Основная сюжетная линия не менялась, были лишь добавлены несколько новых веток."

    hide screen andem
    $ andem = "f/and6.png"
    show screen andem
    with dissolve
    angel "При разработке использовались материалы, появившиеся в так называемом \"Русском моде\" 1.6."
    angel "В общем то, одной из целей данного мода как раз таки является закончить начатые в 1.6. сюжетные ветки"

    hide screen andem
    $ andem = "f/and5.png"
    show screen andem
    with dissolve
    demoness "Страничку автора мода можно найти здесь {a=http://www.patreon.com/Feodosiy}PUSH ME{/a}"
