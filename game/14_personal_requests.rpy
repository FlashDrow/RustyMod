...
#                        jump new_request_09
                    ...
                    "{color=#858585}--Не открытое действие-{/color} -" if imagination < 3:
                        call vague_idea from _call_vague_idea_4
                        jump not_now2
                    ...
                    "{color=#858585}--Не открытое действие-{/color} -" if imagination < 3:
                        call vague_idea from _call_vague_idea_5
                        jump not_now2
                    ...
                    "{color=#858585}--Не открытое действие-{/color} -" if imagination < 4:
                        call vague_idea from _call_vague_idea_6
                        jump not_now2
                    ...
                    "{color=#858585}--Не открытое действие-{/color}-" if imagination < 4:
                        call vague_idea from _call_vague_idea_7
                        jump not_now2
                    "Услуга: \"Потрогай меня! (II)\" {image=heart_00.png}" if (titfuck_points == 0) and (imagination >= 4): # LEVEL 6
                        jump titfucking
                    "Услуга: \"Потрогай меня! (II)\" {image=heart_01.png}" if (titfuck_points == 1) and (imagination >= 4): # LEVEL 6
                        jump titfucking
                    "Услуга: \"Потрогай меня! (II)\" {image=heart_02.png}" if (titfuck_points == 2) and (imagination >= 4): # LEVEL 6
                        jump titfucking
                    "Услуга: \"Потрогай меня! (II)\" {image=heart_03.png}" if (titfuck_points == 3) and (imagination >= 4): # LEVEL 6
                        jump titfucking
                    ...
                    "{color=#858585}--Не открытое действие-{/color} -" if imagination < 4:
                        call vague_idea from _call_vague_idea_17
                        jump not_now2
                    ...
                    "{color=#858585}--Не открытое действие-{/color} -" if imagination < 5:
                        call vague_idea from _call_vague_idea_8
                        jump not_now2
                    ...
                    ### LEVEL 08 ###
                    "{color=#858585}--Не открытое действие-{/color} -" if imagination < 5:
                        call vague_idea from _call_vague_idea_9
                        jump not_now2
                ...
                if lock_public_favors:
                    ...
                    menu:
                        ...
                        "{color=#858585}--Не открытое действие-{/color} -" if imagination < 2:
                            call vague_idea from _call_vague_idea_10
                            jump not_now3
                        ...
                        ### LEVEL 03 ### IMAGINATION == 3
                        "{color=#858585}--Не открытое действие-{/color} -" if imagination < 3:
                            call vague_idea from _call_vague_idea_11
                            jump not_now3
                        ...
                        ### LEVEL 04 ### IMAGINATION == 3
                        "{color=#858585}--Не открытое действие-{/color} -" if imagination < 3:
                            call vague_idea from _call_vague_idea_12
                            jump not_now3
                        ...
                        ### LEVEL 05 ### IMAGINATION == 4
                        "{color=#858585}--Не открытое действие-{/color} -" if imagination < 4:
                            call vague_idea from _call_vague_idea_13
                            jump not_now3
                        ...
                        ### LEVEL 06 ### IMAGINATION == 4
                        "{color=#858585}--Не открытое действие-{/color} -" if imagination < 4:
                            call vague_idea from _call_vague_idea_14
                            jump not_now3
                        ...
                        ### LEVEL 07 ### IMAGINATION == 5
                        "{color=#858585}--Не открытое действие-{/color} -" if imagination < 5:
                            call vague_idea from _call_vague_idea_15
                            jump not_now3
                        ...
                        "{color=#858585}--Не открытое действие-{/color} -" if imagination < 5:
                            call vague_idea from _call_vague_idea_16
                            jump not_now3
...
label new_request_05:
    ...
    call music_block from _call_music_block_19 # Lunches apropriete BGM day/night.
...
label new_request_08: #LV.3 (Whoring = 6 - 8)
    ...
    menu:
        "\"Солгать. Схватить за сиськи!\"":
            if whoring >= 6 and whoring <= 8: # LEVEL 03 # <=================================================================================== FIRST EVENT. HERMIONE OUTRAGED.
                ...
                m "Вы провалились, Мисс Грейнджер..."
                her_19  "Гр.................."
                her_19 "{size=-5}(Гори в аду, извращенский старик---{/size}"
                $ mad += 22
    ...
    call music_block from _call_music_block_24
...
label new_request_11: #LV.4 (Whoring = 9 - 11)
    ...
    if request_11_points == 0: #<==============================EVENT 01
        ...
        show screen hermione_main
        with d3
        call music_block from _call_music_block_25
        her "сэр..?"
        m "Так Гермиона..."
        ...
        menu:
            ...
            "\"Конечно. И ты не получишь очки.\"":
                ...
                $ h_ypos=0 #Defines position of the Hermione's full length sprite. (Default 0). Right bottom corner: 340
                $ mad += 35
                call music_block from _call_music_block_26
                jump could_not_flirt
                                                ...
                                                "\"Ты ни черта не получишь!\"":
                                                    ...
                                                    menu:
                                                        ...
                                                        "\"Нет, их тоже не получишь!\"":
                                                            ...
                                                            hide screen blkfade
                                                            with d3
                                                            call music_block from _call_music_block_27
    ...
    call music_block from _call_music_block_28
    if daytime:
        $ hermione_takes_classes = True
        jump night_main_menu
    else:
...
#                m "What possessed you to put my cock there, м?"
    ...
    $ aftersperm = False #Show cum stains on Hermione's uniform.
    call music_block from _call_music_block_29
    if daytime:
        $ hermione_takes_classes = True
        jump night_main_menu
    else:
