label snape_chitchat:
    ...
    if chimi_event == 18:
      ...
      sna "В этом замке творится черти что"
      m "...."
      m "О чем ты?"
      $ s_sprite = "03_hp/10_snape_main/snape_16.png"
      sna "недавно нашлись пропавшие ученики"
      $ s_sprite = "03_hp/10_snape_main/snape_03.png"
      g9 "ого... ничего об этом не знаю"
      $ s_sprite = "03_hp/10_snape_main/snape_06.png"
      sna "..."
      $ s_sprite = "03_hp/10_snape_main/snape_07.png"
      sna "Вся школа ходила ходуном последнее время из-за этих пропаж"
      $ s_sprite = "03_hp/10_snape_main/24.png"
      sna "Оказалось, что их похищал какой-то толи сатир, толи кто"
      $ s_sprite = "03_hp/10_snape_main/snape_01.png"
      m "..."
      m "ты не знаешь кто это был?"
      $ s_sprite = "03_hp/10_snape_main/snape_06.png"
      sna "нет, его нашел этот очкастый выскочка Поттер"
      $ s_sprite = "03_hp/10_snape_main/23.png"
      sna "Даже не верится, что все это кончилось"
      $ s_sprite = "03_hp/10_snape_main/snape_22.png"
      sna "отличный повод уйти в запой на пару дней"
      $ chimi_event = 19
      g9 "*наконец то эта эпопея с демоном закончилась*"
      jump snape_ready
...
label chit_chat:
    ...
    if devil == 8:
        if one_of_ten == 1:
            her "Последнее время все только и говорят про эти нападения!"
            her "не понимаю, я вообще ничего не замечала"

        elif one_of_ten == 2:
            her "По началу я была возмущена, что у мальчиков и девочек будет один общий врач мужчина"
            her "Но когда увидела его, я поняла, что наша школа идет в ногу со временем..."
            her "Хотя теперь мальчики стесняются ходить к нему"

        elif one_of_ten == 3:
            her "Гарри почему-то начал всюду таскаться за Чжоу Чанг"
            her "Я никак не решаюсь ему сказать, что она говорит о нем, в его отсутствие..."

        elif one_of_ten == 4:
            "Девочки начали жаловаться, будто кто-то постоянно подглядывает за ними"
            "странно, что это началось только сейчас"

        elif one_of_ten == 5:
            "Профессор Макгонгал последние дни очень радостная"
            "Не могу понять, как можно радоваться, когда вокруг происходит такое!"

        elif one_of_ten == 6:
            "Я по началу не хотела учавствовать в турнире..."
            "Но эти дурацкие правила!!! как можно делить волшебников по половому признаку?!"

        elif one_of_ten == 7:
            "Профессор Снейп постоянно подсуживает своему факультету!"
            "На его лекциях Гриффиндор ни разу не получал очки"
            ...
            "На самом деле...{w} я ненавижу квидичч"
            "На матчах никто не смотрит на игру, все пялятся на полуголую группу поддержки"
