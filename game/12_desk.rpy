label desk:
    menu:
        ...
        "Провести ритуал из древней книги" if book_evil == 2:
            $ book_evil = 3
        ...
        "Переводить древнюю книгу на непонятном языке" if book_evil == 1:
            ...
            if devil == 8:
                ...
                with Dissolve(0.3)
                ">Вы пытаетесь перевести старую книгу на древнем языке, который помнили когда-то давно."

                show screen genie
                hide screen paperwork

                m "Закончил!"
                m "Мне удалось вспомнить этот язык за исключением пары глаголов"
                $ book_evil = 2
                m "У меня есть все необходимое, чтобы провести ритуал..."
                menu:
                    "Провести сейчас!":
                        show screen genie
                        hide screen paperwork
                        g4 "Правильно, нахер этот мир!"
                        $ book_evil = 3
                        g9 "горячие сучки аграбы меня уже заждались"
                        jump priziv
        ...
        "-Писать статьи для стенгазеты-" if paper < 3 and paper_level > 2:
            ...
            $ paper += 1
            if paper != 3:
                ">Вы пишете новую статью для выпуска"
            else:
                play sound "sounds/win2.mp3"
                ">Вы закончили новый выпуск газеты"
        ...
        "-Опубликовать выпуск-" if paper == 3:
            play sound "sounds/win2.mp3"
            "> Свежий выпуск стенгазеты отправлен на общую доску объявлений"
            $ paper = 0
            $ paper_event = 0
            $ paper_money = 1
            jump desk    

        "-отправить фото гермионы в порножурнал-" if playwizard == 3:
                ...
                menu:
                                ...
                                menu:
                                    "- Читать книгу -":
                                        if "book_01" in books and book_01_units == 10:
                                            ...
                                            call gal_proper from _call_gal_proper
                                            jump books_on_improvement
                                    "- Ничего -":
                                        hide screen gift
                                        jump books_on_improvement
                                ...
                                menu:
                                    "- Читать книгу -":
                                        if "book_02" in books and book_02_units == 10:
                                            ...
                                            call gal_proper from _call_gal_proper_1
                                            jump books_on_improvement
                                    "- Ничего -":
                                        hide screen gift
                                        jump books_on_improvement
                                ...
                                menu:
                                    "- Читать книгу -":
                                        if "book_03" in books and book_03_units == 10:
                                            ...
                                            call gal_proper from _call_gal_proper_2
                                            jump books_on_improvement
                                    "- Ничего -":
                                        hide screen gift
                                        jump books_on_improvement
                                ...
                                menu:
                                    "- Читать книгу -":
                                        if "book_04" in books and book_04_units == 10:
                                            ...
                                            call gal_proper from _call_gal_proper_3
                                            jump books_on_improvement
                                    "- Ничего -":
                                        hide screen gift
                                        jump books_on_improvement
                                ...
                                menu:
                                    "- Читать книгу -":
                                        if "book_10" in books and book_10_units == 10:
                                            ...
                                            call gal_proper from _call_gal_proper_4
                                            jump books_on_improvement
                                    "- Ничего -":
                                        hide screen gift
                                        jump books_on_improvement
                                ...
                                menu:
                                    "- Читать книгу -":
                                         if "book_12" in books and book_12_units == 10:
                                            ...
                                            call gal_proper from _call_gal_proper_5
                                            jump books_on_improvement
                                    "- Ничего -":
                                        hide screen gift
                                        jump books_on_improvement
                                ...
                                menu:
                                    "- Читать книгу -":
                                        if "book_13" in books and book_13_units == 10:
                                            ...
                                            call gal_proper from _call_gal_proper_6
                                            jump books_on_improvement
                                    "- Ничего -":
                                        hide screen gift
                                        jump books_on_improvement
                                ...
                                menu:
                                    "- Читать книгу -":
                                        if "book_14" in books and book_14_units == 10:
                                            ...
                                            call gal_proper from _call_gal_proper_7
                                            jump books_on_improvement
                                    "- Ничего -":
                                        hide screen gift
                                        jump books_on_improvement
                                ...
                                menu:
                                    "- Читать книгу -":
                                        if "book_15" in books and book_15_units == 10:
                                            ...
                                            call gal_proper from _call_gal_proper_8
                                            jump books_on_improvement
                                    "- Ничего -":
                                        hide screen gift
                                        jump books_on_improvement
                                ...
                                menu:
                                    "- Читать книгу -":
                                        if "book_16" in books and book_16_units == 10:
                                            ...
                                            call gal_proper from _call_gal_proper_9
                                            jump books_on_improvement
                                    "- Ничего -":
                                        hide screen gift
                                        jump books_on_improvement
                                ...
                                menu:
                                    "- Читать книгу -":
                                        if "book_08" in books and book_08_units == 10:
                                            ...
                                            call gal_proper from _call_gal_proper_10
                                            jump books_on_improvement
                                    "- Ничего -":
                                        hide screen gift
                                        jump books_on_improvement
                    ...
                    "- Фантастика -":#FICTION==============================================================================
                        ...
                        menu:
                            ...
                            "- Книга [book05_b] -" if "book_05_b" in books and book_05_b_units <= 19:
                                ...
                                menu:
                                    "- Читать книгу -":
                                        if "book_05" in books and book_05_units == 20: # MAKES SURE YOU DON'T READ PART II BEFORE PART I.
                                            ...
                                            call gal_proper from _call_gal_proper_11
                                            jump  fiction_books

                                    "- Ничего -":
                                        hide screen gift
                                        jump  fiction_books
                            "- Книга [book05_b] -{image=check_08.png}" if "book_05_b" in books and book_05_b_units == 20:
                                $ the_gift = "03_hp/18_store/05.png" # THE TALE OF GALADRIEL. BOOK TWO.
                                show screen gift
                                ">Эта книга содержит довольно длинную историю, описывающую в мельчайших подробностях жизнь и приключения молодой эльфийки по имени Галадриэль."
                                ">Вы уже закончили эту книгу."
...
label reading_book_01:
    ...
    call reading_block from _call_reading_block

    hide screen gift
    with d3
    if fire_in_fireplace:
        call fire_in from _call_fire_in #Shows Genie reading a book near the fireplace.
    else:
        call fire_out from _call_fire_out #Shows Genie reading a book near the window.
    ...
    call chap_finished from _call_chap_finished

    call chapter_check_book_01 from _call_chapter_check_book_01 #Checks if the chapter just finished was the last one.
...
#===### SPEED READING FOR DUMMIES BONUS CHECK ###
    if s_reading_lvl == 1: #First book (book_08) on speed reading completed.
        ...
        if speed_dummies == 1: #Success.
            call yes_book_08 from _call_yes_book_08 #Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished from _call_chap_finished_1
            call chapter_check_book_01 from _call_chapter_check_book_01_1 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
    ...
    if s_reading_lvl == 2: #Second book(book_09) on speed reading completed.
        ...
        #$ speed_dummies = 1 #Here for testing porpoise only.
        if speed_dummies == 1: #Success.
            call yes_book_09 from _call_yes_book_09 #Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished from _call_chap_finished_2
            call chapter_check_book_01 from _call_chapter_check_book_01_2 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
...
#===#############################################
    ...
    if raining:
        if not fire_in_fireplace:
            call no_fire from _call_no_fire #Message you see that says you are reading a book during rain.
        else:
            call yes_fire from _call_yes_fire #Message you see that says you are reading a book during rain near fireplace.
            call chap_finished from _call_chap_finished_3
            call chapter_check_book_01 from _call_chapter_check_book_01_3 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
...
label reading_book_02:
    ...
    call reading_block from _call_reading_block_1

    hide screen gift
    with d3
    if fire_in_fireplace:
        call fire_in from _call_fire_in_1 #Shows Genie reading a book near the fireplace.
    else:
        call fire_out from _call_fire_out_1 #Shows Genie reading a book near the window.
    ...
    call chap_finished_02 from _call_chap_finished_02

    call chapter_check_book_02 from _call_chapter_check_book_02 #Checks if the chapter just finished was the last one.
...
#===### SPEED READING FOR DUMMIES BONUS CHECK ###
    if s_reading_lvl == 1: #First book (book_08) on speed reading completed.
        ...
        #$ speed_dummies = 1 #Here for testing porpoise only.
        if speed_dummies == 1: #Success.
            call yes_book_08 from _call_yes_book_08_1 #Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_02 from _call_chap_finished_02_1
            call chapter_check_book_02 from _call_chapter_check_book_02_1 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
    ...
    if s_reading_lvl == 2: #Second book(book_09) on speed reading completed.
        ...
        #$ speed_dummies = 1 #Here for testing porpoise only.
        if speed_dummies == 1: #Success.
            call yes_book_09 from _call_yes_book_09_1 #Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_02 from _call_chap_finished_02_2
            call chapter_check_book_02 from _call_chapter_check_book_02_2 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
#===#############################################

    if raining:
        if not fire_in_fireplace:
            call no_fire from _call_no_fire_1 #Message you see that says you are reading a book during rain.
        else:
            call yes_fire from _call_yes_fire_1 #Message you see that says you are reading a book during rain near fireplace.
            call chap_finished_02 from _call_chap_finished_02_3
            call chapter_check_book_02 from _call_chapter_check_book_02_3 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
...
label reading_book_03:
    ...
    call reading_block from _call_reading_block_2

    hide screen gift

    if fire_in_fireplace:
        call fire_in from _call_fire_in_2 #Shows Genie reading a book near the fireplace.
    else:
        call fire_out from _call_fire_out_2 #Shows Genie reading a book near the window.
    ...
    call chap_finished_03 from _call_chap_finished_03

    call chapter_check_book_03 from _call_chapter_check_book_03 #Checks if the chapter just finished was the last one.
...
#===### SPEED READING FOR DUMMIES BONUS CHECK ###
    if s_reading_lvl == 1: #First book (book_08) on speed reading completed.
        ...
        #$ speed_dummies = 1 #Here for testing porpoise only.
        if speed_dummies == 1: #Success.
            call yes_book_08 from _call_yes_book_08_2 #DON'T CHANGE! KEEP IT 08. Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_03 from _call_chap_finished_03_1
            call chapter_check_book_03 from _call_chapter_check_book_03_1 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
    ...
    if s_reading_lvl == 2: #Second book(book_09) on speed reading completed.
        ...
        #$ speed_dummies = 1 #Here for testing porpoise only.
        if speed_dummies == 1: #Success.
            call yes_book_09 from _call_yes_book_09_2 #DON'T CHANGE! KEEP IT 09 Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_03 from _call_chap_finished_03_2
            call chapter_check_book_03 from _call_chapter_check_book_03_2 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
#===#############################################

    if raining:
        if not fire_in_fireplace:
            call no_fire from _call_no_fire_2 #Message you see that says you are reading a book during rain.
        else:
            call yes_fire from _call_yes_fire_2 #Message you see that says you are reading a book during rain near fireplace.
            call chap_finished_03 from _call_chap_finished_03_3
            call chapter_check_book_03 from _call_chapter_check_book_03_3 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
...
label reading_book_04:
    ...
    call reading_block from _call_reading_block_3

    hide screen gift
    if fire_in_fireplace:
        call fire_in from _call_fire_in_3 #Shows Genie reading a book near the fireplace.
    else:
        call fire_out from _call_fire_out_3 #Shows Genie reading a book near the window.
    ...
    call chap_finished_04 from _call_chap_finished_04

    call chapter_check_book_04 from _call_chapter_check_book_04 #Checks if the chapter just finished was the last one.
...
#===### SPEED READING FOR DUMMIES BONUS CHECK ###
    if s_reading_lvl == 1: #First book (book_08) on speed reading completed.
        ...
        #$ speed_dummies = 1 #Here for testing porpoise only.
        if speed_dummies == 1: #Success.
            call yes_book_08 from _call_yes_book_08_3 #DON'T CHANGE! KEEP IT 08. Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_04 from _call_chap_finished_04_1
            call chapter_check_book_04 from _call_chapter_check_book_04_1 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
    ...
    if s_reading_lvl == 2: #Second book(book_09) on speed reading completed.
        ...
        #$ speed_dummies = 1 #Here for testing porpoise only.
        if speed_dummies == 1: #Success.
            call yes_book_09 from _call_yes_book_09_3 #DON'T CHANGE! KEEP IT 09 Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_04 from _call_chap_finished_04_2
            call chapter_check_book_04 from _call_chapter_check_book_04_2 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
#===#############################################

    if raining:
        if not fire_in_fireplace:
            call no_fire from _call_no_fire_3 #Message you see that says you are reading a book during rain.
        else:
            call yes_fire from _call_yes_fire_3 #Message you see that says you are reading a book during rain near fireplace.
            call chap_finished_04 from _call_chap_finished_04_3
            call chapter_check_book_04 from _call_chapter_check_book_04_3 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
...
label reading_book_05:
    ...
    if fire_in_fireplace:
        ...
        call fire_in from _call_fire_in_4 #Shows Genie reading a book near the fireplace.
    else:
        call fire_out from _call_fire_out_4 #Shows Genie reading a book near the window.
    ...
    call chap_finished_05 from _call_chap_finished_05

    call chapter_check_book_05 from _call_chapter_check_book_05 #Checks if the chapter just finished was the last one.
...
#===### SPEED READING FOR DUMMIES BONUS CHECK ###
    if s_reading_lvl == 1: #First book (book_08) on speed reading completed.
        ...
        #$ speed_dummies = 1 #Here for testing porpoise only.
        if speed_dummies == 1: #Success.
            call yes_book_08 from _call_yes_book_08_4 #Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_05 from _call_chap_finished_05_1
            call chapter_check_book_05 from _call_chapter_check_book_05_1 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
    if s_reading_lvl == 2: #Second book(book_09) on speed reading completed.
        $ speed_dummies = renpy.random.randint(1, 2)
        #$ speed_dummies = 1 #Here for testing porpoise only.
        if speed_dummies == 1: #Success.
            call yes_book_09 from _call_yes_book_09_4 #Message you see that says you are completed both speed reading books.
            call chap_finished_05 from _call_chap_finished_05_2
            call chapter_check_book_05 from _call_chapter_check_book_05_2 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
#===#############################################

    if raining:
        if not fire_in_fireplace:
            call no_fire from _call_no_fire_4 #Message you see that says you are reading a book during rain.
        else:
            call yes_fire from _call_yes_fire_4 #Message you see that says you are reading a book during rain near fireplace.
            call chap_finished_05 from _call_chap_finished_05_3
            call chapter_check_book_05 from _call_chapter_check_book_05_3 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
...
label reading_book_05_b: ### TALE OF GALADRIEL. BOOK TWO.
    ...
    if fire_in_fireplace:
        call fire_in from _call_fire_in_5 #Shows Genie reading a book near the fireplace.
    else:
        call fire_out from _call_fire_out_5 #Shows Genie reading a book near the window.

    if raining:
        ">Вы читаете книгу под названием [book05_b], в тоже время слушая дождь, заливающий крышу вашей башни."
    else:
        ">Вы читаете книгу под названием [book05_b]"

    call chap_finished_05_b from _call_chap_finished_05_b

    call chapter_check_book_05_b from _call_chapter_check_book_05_b #Checks if the chapter just finished was the last one.
...
#===### SPEED READING FOR DUMMIES BONUS CHECK ###
    if s_reading_lvl == 1: #First book (book_08) on speed reading completed.
        $ speed_dummies = renpy.random.randint(1, 3)
        if speed_dummies == 1: #Success.
            call yes_book_08 from _call_yes_book_08_5 #Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_05_b from _call_chap_finished_05_b_1
            call chapter_check_book_05_b from _call_chapter_check_book_05_b_1 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
    if s_reading_lvl == 2: #Second book(book_09) on speed reading completed.
        $ speed_dummies = renpy.random.randint(1, 2)
        if speed_dummies == 1: #Success.
            call yes_book_09 from _call_yes_book_09_5 #Message you see that says you are completed both speed reading books.
            call chap_finished_05_b from _call_chap_finished_05_b_2
            call chapter_check_book_05_b from _call_chapter_check_book_05_b_2 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
#===#############################################

    if raining:
        if not fire_in_fireplace:
            call no_fire from _call_no_fire_5 #Message you see that says you are reading a book during rain.
        else:
            call yes_fire from _call_yes_fire_5 #Message you see that says you are reading a book during rain near fireplace.
            call chap_finished_05_b from _call_chap_finished_05_b_3
            call chapter_check_book_05_b from _call_chapter_check_book_05_b_3 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
...
label reading_book_06:
    ...
    call reading_block from _call_reading_block_4

    if fire_in_fireplace:
        call fire_in from _call_fire_in_6 #Shows Genie reading a book near the fireplace.
    else:
        call fire_out from _call_fire_out_6 #Shows Genie reading a book near the window.
    ...
    call chap_finished_06 from _call_chap_finished_06

    call chapter_check_book_06 from _call_chapter_check_book_06 #Checks if the chapter just finished was the last one.
    ">Осталось еще несколько глав."
...
#===### SPEED READING FOR DUMMIES BONUS CHECK ###
    if s_reading_lvl == 1: #First book (book_08) on speed reading completed.
        ...
        #$ speed_dummies = 1 #Here for testing porpoise only.
        if speed_dummies == 1: #Success.
            call yes_book_08 from _call_yes_book_08_6 #Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_06 from _call_chap_finished_06_1
            call chapter_check_book_06 from _call_chapter_check_book_06_1 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
    if s_reading_lvl == 2: #Second book(book_09) on speed reading completed.
        $ speed_dummies = renpy.random.randint(1, 2)
        #$ speed_dummies = 1 #Here for testing porpoise only.
        if speed_dummies == 1: #Success.
            call yes_book_09 from _call_yes_book_09_6 #Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_06 from _call_chap_finished_06_2
            call chapter_check_book_06 from _call_chapter_check_book_06_2 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
#===#############################################
    ...
    if raining:
        if not fire_in_fireplace:
            call no_fire from _call_no_fire_6 #Message you see that says you are reading a book during rain.
        else:
            call yes_fire from _call_yes_fire_6 #Message you see that says you are reading a book during rain near fireplace.
            call chap_finished_06 from _call_chap_finished_06_3
            call chapter_check_book_06 from _call_chapter_check_book_06_3 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
...
label reading_book_07:
    ...
    call reading_block from _call_reading_block_5

    if fire_in_fireplace:
        call fire_in from _call_fire_in_7 #Shows Genie reading a book near the fireplace.
    else:
        call fire_out from _call_fire_out_7 #Shows Genie reading a book near the window.
    ...
    call chap_finished_07 from _call_chap_finished_07

    call chapter_check_book_07 from _call_chapter_check_book_07 #Checks if the chapter just finished was the last one.
...
#===### SPEED READING FOR DUMMIES BONUS CHECK ###
    if s_reading_lvl == 1: #First book (book_08) on speed reading completed.
        ...
        #$ speed_dummies = 1 #Here for testing porpoise only.
        if speed_dummies == 1: #Success.
            call yes_book_08 from _call_yes_book_08_7 #Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_07 from _call_chap_finished_07_1
            call chapter_check_book_07 from _call_chapter_check_book_07_1 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
    if s_reading_lvl == 2: #Second book(book_09) on speed reading completed.
#        $ speed_dummies = renpy.random.randint(1, 2)
#        #$ speed_dummies = 1 #Here for testing porpoise only.
#        if speed_dummies == 1: #Success.
        call yes_book_09 from _call_yes_book_09_7 #Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
        call chap_finished_07 from _call_chap_finished_07_2
        call chapter_check_book_07 from _call_chapter_check_book_07_2 #Checks if the chapter just finished was the last one.
        ">Осталось еще несколько глав."
#===#############################################

    if raining:
        if not fire_in_fireplace:
            call no_fire from _call_no_fire_7 #Message you see that says you are reading a book during rain.
        else:
            call yes_fire from _call_yes_fire_7 #Message you see that says you are reading a book during rain near fireplace.
            call chap_finished_07 from _call_chap_finished_07_3
            call chapter_check_book_07 from _call_chapter_check_book_07_3 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
...
label reading_book_08:
    ...
    call reading_block from _call_reading_block_6

    hide screen gift
    if fire_in_fireplace:
        call fire_in from _call_fire_in_8 #Shows Genie reading a book near the fireplace.
    else:
        call fire_out from _call_fire_out_8 #Shows Genie reading a book near the window.
    ...
    call chap_finished_08 from _call_chap_finished_08

    call chapter_check_book_08 from _call_chapter_check_book_08 #Checks if the chapter just finished was the last one.
    ...
    if raining:
        if not fire_in_fireplace:
            call no_fire from _call_no_fire_8 #Message you see that says you are reading a book during rain.
        else:
            call yes_fire from _call_yes_fire_8 #Message you see that says you are reading a book during rain near fireplace.
            call chap_finished_08 from _call_chap_finished_08_1
            call chapter_check_book_08 from _call_chapter_check_book_08_1 #Checks if the chapter just finished was the last one.
...
label reading_book_09:
    ...
    call reading_block from _call_reading_block_7 ### Plays sound effects appropriate for reading.

    hide screen gift
    if fire_in_fireplace:
        call fire_in from _call_fire_in_9 #Shows Genie reading a book near the fireplace.
    else:
        call fire_out from _call_fire_out_9 #Shows Genie reading a book near the window.
    ...
    call chap_finished_09 from _call_chap_finished_09

    call chapter_check_book_09 from _call_chapter_check_book_09 #Checks if the chapter just finished was the last one.
...
#===### SPEED READING FOR DUMMIES BONUS CHECK ###
    if s_reading_lvl == 1: #First book (book_08) on speed reading completed.
        ...
        #$ speed_dummies = 1 #Here for testing porpoise only.
        if speed_dummies == 1: #Success.
            call yes_book_08 from _call_yes_book_08_8 #Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_09 from _call_chap_finished_09_1
            call chapter_check_book_09 from _call_chapter_check_book_09_1 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
#===#############################################

    if raining:
        if not fire_in_fireplace:
            call no_fire from _call_no_fire_9 #Message you see that says you are reading a book during rain.
        else:
            call yes_fire from _call_yes_fire_9 #Message you see that says you are reading a book during rain near fireplace.
            call chap_finished_09 from _call_chap_finished_09_2
            call chapter_check_book_09 from _call_chapter_check_book_09_2 #Checks if the chapter just finished was the last one.
...
label reading_book_10:
    hide screen gift
    call reading_block from _call_reading_block_8

    if fire_in_fireplace:
        call fire_in from _call_fire_in_10 #Shows Genie reading a book near the fireplace.
    else:
        call fire_out from _call_fire_out_10 #Shows Genie reading a book near the window.
    ...
    call chap_finished_10 from _call_chap_finished_10 #Basicly $ book_04_units +=1 and "Chapter completed" message.

    call chapter_check_book_10 from _call_chapter_check_book_10 #Checks if the chapter just finished was the last one.
...
#===### SPEED READING FOR DUMMIES BONUS CHECK ###
    if s_reading_lvl == 1: #First book (book_08) on speed reading completed.
        ...
        #$ speed_dummies = 1 #Here for testing porpoise only.
        if speed_dummies == 1: #Success.
            call yes_book_08 from _call_yes_book_08_9 #DON'T CHANGE! KEEP IT 08. Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_10 from _call_chap_finished_10_1
            call chapter_check_book_10 from _call_chapter_check_book_10_1 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
    ...
    if s_reading_lvl == 2: #Second book(book_09) on speed reading completed.
        ...
        #$ speed_dummies = 1 #Here for testing porpoise only.
        if speed_dummies == 1: #Success.
            call yes_book_09 from _call_yes_book_09_8 #DON'T CHANGE! KEEP IT 09 Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_10 from _call_chap_finished_10_2
            call chapter_check_book_10 from _call_chapter_check_book_10_2 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
#===#############################################

    if raining:
        if not fire_in_fireplace:
            call no_fire from _call_no_fire_10 #Message you see that says you are reading a book during rain.
        else:
            call yes_fire from _call_yes_fire_10 #Message you see that says you are reading a book during rain near fireplace.
            call chap_finished_10 from _call_chap_finished_10_3
            call chapter_check_book_10 from _call_chapter_check_book_10_3 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
...
label reading_book_11:
    ...
    call reading_block from _call_reading_block_9

    hide screen gift
    if fire_in_fireplace:
        call fire_in from _call_fire_in_11 #Shows Genie reading a book near the fireplace.
    else:
        call fire_out from _call_fire_out_11 #Shows Genie reading a book near the window.
    ...
    call chap_finished_11 from _call_chap_finished_11 #Basicly $ book_04_units +=1 and "Chapter completed" message.

    call chapter_check_book_11 from _call_chapter_check_book_11 #Checks if the chapter just finished was the last one.
...
#===### SPEED READING FOR DUMMIES BONUS CHECK ###
    if s_reading_lvl == 1: #First book (book_08) on speed reading completed.
        ...
        #$ speed_dummies = 1 #Here for testing porpoise only.
        if speed_dummies == 1: #Success.
            call yes_book_08 from _call_yes_book_08_10 #DON'T CHANGE! KEEP IT 08. Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_11 from _call_chap_finished_11_1
            call chapter_check_book_11 from _call_chapter_check_book_11_1 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
    ...
    if s_reading_lvl == 2: #Second book(book_09) on speed reading completed.
        ...
        #$ speed_dummies = 1 #Here for testing porpoise only.
        if speed_dummies == 1: #Success.
            call yes_book_09 from _call_yes_book_09_9 #DON'T CHANGE! KEEP IT 09 Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_11 from _call_chap_finished_11_2
            call chapter_check_book_11 from _call_chapter_check_book_11_2 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
#===#############################################

    if raining:
        if not fire_in_fireplace:
            call no_fire from _call_no_fire_11 #Message you see that says you are reading a book during rain.
        else:
            call yes_fire from _call_yes_fire_11 #Message you see that says you are reading a book during rain near fireplace.
            call chap_finished_11 from _call_chap_finished_11_3
            call chapter_check_book_11 from _call_chapter_check_book_11_3 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
...
label reading_book_12:
    ...
    call reading_block from _call_reading_block_10

    hide screen gift
    if fire_in_fireplace:
        call fire_in from _call_fire_in_12 #Shows Genie reading a book near the fireplace.
    else:
        call fire_out from _call_fire_out_12 #Shows Genie reading a book near the window.
    ...
    call chap_finished_12 from _call_chap_finished_12 #Basicly $ book_04_units +=1 and "Chapter completed" message.

    call chapter_check_book_12 from _call_chapter_check_book_12 #Checks if the chapter just finished was the last one.
...
#===### SPEED READING FOR DUMMIES BONUS CHECK ###
    if s_reading_lvl == 1: #First book (book_08) on speed reading completed.
        ...
        #$ speed_dummies = 1 #Here for testing porpoise only.
        if speed_dummies == 1: #Success.
            call yes_book_08 from _call_yes_book_08_11 #DON'T CHANGE! KEEP IT 08. Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_12 from _call_chap_finished_12_1
            call chapter_check_book_12 from _call_chapter_check_book_12_1 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."

    if s_reading_lvl == 2: #Second book(book_09) on speed reading completed.
        $ speed_dummies = renpy.random.randint(1, 3)
        if speed_dummies == 1: #Success.
            call yes_book_09 from _call_yes_book_09_10 #DON'T CHANGE! KEEP IT 09 Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_12 from _call_chap_finished_12_2
            call chapter_check_book_12 from _call_chapter_check_book_12_2 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
#===#############################################

    if raining:
        if not fire_in_fireplace:
            call no_fire from _call_no_fire_12 #Message you see that says you are reading a book during rain.
        else:
            call yes_fire from _call_yes_fire_12 #Message you see that says you are reading a book during rain near fireplace.
            call chap_finished_12 from _call_chap_finished_12_3
            call chapter_check_book_12 from _call_chapter_check_book_12_3 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
...
label reading_book_13:
    ...
    call reading_block from _call_reading_block_11

    hide screen gift
    if fire_in_fireplace:
        call fire_in from _call_fire_in_13 #Shows Genie reading a book near the fireplace.
    else:
        call fire_out from _call_fire_out_13 #Shows Genie reading a book near the window.
    ...
    call chap_finished_13 from _call_chap_finished_13 #Basicly $ book_04_units +=1 and "Chapter completed" message.

    call chapter_check_book_13 from _call_chapter_check_book_13 #Checks if the chapter just finished was the last one.
...
#===### SPEED READING FOR DUMMIES BONUS CHECK ###
    if s_reading_lvl == 1: #First book (book_08) on speed reading completed.
        ...
        #$ speed_dummies = 1 #Here for testing porpoise only.
        if speed_dummies == 1: #Success.
            call yes_book_08 from _call_yes_book_08_12 #DON'T CHANGE! KEEP IT 08. Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_13 from _call_chap_finished_13_1

    if s_reading_lvl == 2: #Second book(book_09) on speed reading completed.
        $ speed_dummies = renpy.random.randint(1, 3)
        if speed_dummies == 1: #Success.
            call yes_book_09 from _call_yes_book_09_11 #DON'T CHANGE! KEEP IT 09 Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_13 from _call_chap_finished_13_2

#===#############################################

    call chapter_check_book_13 from _call_chapter_check_book_13_1 #Checks if the chapter just finished was the last one.
    ">Осталось еще несколько глав."

    if raining:
        if not fire_in_fireplace:
            call no_fire from _call_no_fire_13 #Message you see that says you are reading a book during rain.
        else:
            call yes_fire from _call_yes_fire_13 #Message you see that says you are reading a book during rain near fireplace.
            call chap_finished_13 from _call_chap_finished_13_3
            call chapter_check_book_13 from _call_chapter_check_book_13_2 #Checks if the chapter just finished was the last one.
            ">Осталось еще несколько глав."
...
label reading_book_14:
    ...
    call reading_block from _call_reading_block_12

    hide screen gift
    if fire_in_fireplace:
        call fire_in from _call_fire_in_14 #Shows Genie reading a book near the fireplace.
    else:
        call fire_out from _call_fire_out_14 #Shows Genie reading a book near the window.
    ...
    call chap_finished_14 from _call_chap_finished_14 #Basicly $ book_04_units +=1 and "Chapter completed" message.

    call chapter_check_book_14 from _call_chapter_check_book_14 #Checks if the chapter just finished was the last one.
...
#===### SPEED READING FOR DUMMIES BONUS CHECK ###
    if s_reading_lvl == 1: #First book (book_08) on speed reading completed.
        ...
        #$ speed_dummies = 1 #Here for testing porpoise only.
        if speed_dummies == 1: #Success.
            call yes_book_08 from _call_yes_book_08_13 #DON'T CHANGE! KEEP IT 08. Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_14 from _call_chap_finished_14_1

    if s_reading_lvl == 2: #Second book(book_09) on speed reading completed.
        $ speed_dummies = renpy.random.randint(1, 3)
        if speed_dummies == 1: #Success.
            call yes_book_09 from _call_yes_book_09_12 #DON'T CHANGE! KEEP IT 09 Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_14 from _call_chap_finished_14_2

#===#############################################

    call chapter_check_book_14 from _call_chapter_check_book_14_1 #Checks if the chapter just finished was the last one.


    if raining:
        if not fire_in_fireplace:
            call no_fire from _call_no_fire_14 #Message you see that says you are reading a book during rain.
        else:
            call yes_fire from _call_yes_fire_14 #Message you see that says you are reading a book during rain near fireplace.
            call chap_finished_14 from _call_chap_finished_14_3
            call chapter_check_book_14 from _call_chapter_check_book_14_2 #Checks if the chapter just finished was the last one.
...
label reading_book_15:
    ...
    call reading_block from _call_reading_block_13

    hide screen gift
    if fire_in_fireplace:
        call fire_in from _call_fire_in_15 #Shows Genie reading a book near the fireplace.
    else:
        call fire_out from _call_fire_out_15 #Shows Genie reading a book near the window.
    ...
    call chap_finished_15 from _call_chap_finished_15 #Basicly $ book_04_units +=1 and "Chapter completed" message.

    call chapter_check_book_15 from _call_chapter_check_book_15 #Checks if the chapter just finished was the last one.
...
#===### SPEED READING FOR DUMMIES BONUS CHECK ###
    if s_reading_lvl == 1: #First book (book_08) on speed reading completed.
        ...
        #$ speed_dummies = 1 #Here for testing porpoise only.
        if speed_dummies == 1: #Success.
            call yes_book_08 from _call_yes_book_08_14 #DON'T CHANGE! KEEP IT 08. Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_15 from _call_chap_finished_15_1

    if s_reading_lvl == 2: #Second book(book_09) on speed reading completed.
        $ speed_dummies = renpy.random.randint(1, 3)
        if speed_dummies == 1: #Success.
            call yes_book_09 from _call_yes_book_09_13 #DON'T CHANGE! KEEP IT 09 Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_15 from _call_chap_finished_15_2

#===#############################################

    call chapter_check_book_15 from _call_chapter_check_book_15_1 #Checks if the chapter just finished was the last one.


    if raining:
        if not fire_in_fireplace:
            call no_fire from _call_no_fire_15 #Message you see that says you are reading a book during rain.
        else:
            call yes_fire from _call_yes_fire_15 #Message you see that says you are reading a book during rain near fireplace.
            call chap_finished_15 from _call_chap_finished_15_3
            call chapter_check_book_15 from _call_chapter_check_book_15_2 #Checks if the chapter just finished was the last one.
...
label reading_book_16:
    ...
    call reading_block from _call_reading_block_14

    hide screen gift
    if fire_in_fireplace:
        call fire_in from _call_fire_in_16 #Shows Genie reading a book near the fireplace.
    else:
        call fire_out from _call_fire_out_16 #Shows Genie reading a book near the window.
    ...
    call chap_finished_16 from _call_chap_finished_16 #Basicly $ book_04_units +=1 and "Chapter completed" message.

    call chapter_check_book_16 from _call_chapter_check_book_16 #Checks if the chapter just finished was the last one.
...
#===### SPEED READING FOR DUMMIES BONUS CHECK ###
    if s_reading_lvl == 1: #First book (book_08) on speed reading completed.
        ...
        #$ speed_dummies = 1 #Here for testing porpoise only.
        if speed_dummies == 1: #Success.
            call yes_book_08 from _call_yes_book_08_15 #DON'T CHANGE! KEEP IT 08. Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_16 from _call_chap_finished_16_1

    if s_reading_lvl == 2: #Second book(book_09) on speed reading completed.
        $ speed_dummies = renpy.random.randint(1, 3)
        if speed_dummies == 1: #Success.
            call yes_book_09 from _call_yes_book_09_14 #DON'T CHANGE! KEEP IT 09 Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_16 from _call_chap_finished_16_2

#===#############################################

    call chapter_check_book_16 from _call_chapter_check_book_16_1 #Checks if the chapter just finished was the last one.


    if raining:
        if not fire_in_fireplace:
            call no_fire from _call_no_fire_16 #Message you see that says you are reading a book during rain.
        else:
            call yes_fire from _call_yes_fire_16 #Message you see that says you are reading a book during rain near fireplace.
            call chap_finished_16 from _call_chap_finished_16_3
            call chapter_check_book_16 from _call_chapter_check_book_16_2 #Checks if the chapter just finished was the last one.
...
label reading_book_17:
    ...
    call reading_block from _call_reading_block_15

    hide screen gift
    if fire_in_fireplace:
        call fire_in from _call_fire_in_17 #Shows Genie reading a book near the fireplace.
    else:
        call fire_out from _call_fire_out_17 #Shows Genie reading a book near the window.
    ...
    call chap_finished_17 from _call_chap_finished_17 #Basicly $ book_04_units +=1 and "Chapter completed" message.

    call chapter_check_book_17 from _call_chapter_check_book_17 #Checks if the chapter just finished was the last one.
...
#===### SPEED READING FOR DUMMIES BONUS CHECK ###
    if s_reading_lvl == 1: #First book (book_08) on speed reading completed.
        ...
        #$ speed_dummies = 1 #Here for testing porpoise only.
        if speed_dummies == 1: #Success.
            call yes_book_08 from _call_yes_book_08_16 #DON'T CHANGE! KEEP IT 08. Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_17 from _call_chap_finished_17_1

    if s_reading_lvl == 2: #Second book(book_09) on speed reading completed.
        $ speed_dummies = renpy.random.randint(1, 3)
        if speed_dummies == 1: #Success.
            call yes_book_09 from _call_yes_book_09_15 #DON'T CHANGE! KEEP IT 09 Message you see that says you are completed one more chapter because of the "Speed reading for dummies" book.
            call chap_finished_17 from _call_chap_finished_17_2

#===#############################################

    call chapter_check_book_17 from _call_chapter_check_book_17_1 #Checks if the chapter just finished was the last one.


    if raining:
        if not fire_in_fireplace:
            call no_fire from _call_no_fire_17 #Message you see that says you are reading a book during rain.
        else:
            call yes_fire from _call_yes_fire_17 #Message you see that says you are reading a book during rain near fireplace.
            call chap_finished_17 from _call_chap_finished_17_3
            call chapter_check_book_17 from _call_chapter_check_book_17_2 #Checks if the chapter just finished was the last one.
...
label paperwork:
    ...
    if daytime: # Makes sure that check happens only at nighttime.
        ...
        if wather_generator >= 51 and wather_generator <= 60: # FULL MOON
            call f_moon_bonus from _call_f_moon_bonus_1
    ...
    if concentration == 2:
        ...
        if concentraton_check == 1:
            call concentration_label from _call_concentration_label_1
    if concentration == 3:
        $ concentraton_check = renpy.random.randint(1, 2) #Silver book.
        if concentraton_check == 1:
            call concentration_label from _call_concentration_label_2
    if concentration == 4:                                                               #Golden book.
        call concentration_label from _call_concentration_label_3
#    if concentration == 5:
...
label reading_block:
    ...
    if fire_in_fireplace:
        ...
        call fire_out from _call_fire_out_18 #Shows Genie reading a book near the window.
